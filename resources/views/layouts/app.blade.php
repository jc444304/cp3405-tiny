                    ...
                    <div class="footer-section affiliates">
                        <div class="affiliates-traditional-text">
                            <div class="affiliate-icon-link"><a class="footer-affiliate-link" href="https://www.jcu.edu.au/ierc" title="Indigenous Education Link">
                                    <img class="footer-affiliate-link-image5" src="http://joblink.test/images/footer/affiliates-icons/aboriginal-flag.svg" height="60" alt="Aboriginal Flag"></a>
                            </div>
                            ...
                            <div class="affiliate-icon-link"><a class="footer-affiliate-link" href="https://www.jcu.edu.au/ierc" title="Indigenous Education Link">
                                    <img class="footer-affiliate-link-image5" src="http://joblink.test/images/footer/affiliates-icons/torres-strait.svg" height="60" alt="Torres Strait Flag"></a>
                            </div>
                        </div>
                        <div class="footer-affiliate-icon-section">
                            <div class="affiliate-icon-link"><a class="footer-affiliate-link" href="http://www.studyinaustralia.gov.au/global/why-australia" title="Australia Future Unlimited">
                                    <img class="footer-affiliate-link-image1" src="http://joblink.test/images/footer/affiliates-icons/australia-future-unlimited.svg" height="60" alt="Australia Future Unlimited logo"></a>
                            </div>
                            <div class="affiliate-icon-link"><a class="footer-affiliate-link" href="https://www.iru.edu.au/" title="Innovative Research Universities">
                                    <img class="footer-affiliate-link-image2" src="http://joblink.test/images/footer/affiliates-icons/innovative-research-universities.svg" alt="Innovative Research Universities logo"></a>
                            </div>
                            <div class="affiliate-icon-link"><a class="footer-affiliate-link" href="https://www.universitiesaustralia.edu.au/" title="Universities Australia">
                                    <img class="footer-affiliate-link-image3" src="http://joblink.test/images/footer/affiliates-icons/universities-australia-2018-blue.svg" alt="Universities Australia logo"></a>
                            </div>
                            <div class="affiliate-icon-link"><a class="footer-affiliate-link" href="https://www.jcu.edu.au/state-of-the-tropics" title="State Of The Tropics">
                                    <img class="footer-affiliate-link-image4" src="http://joblink.test/images/footer/affiliates-icons/SOTT3.svg" alt="State Of The Tropics logo"></a>
                            </div>
                        </div>
                    </div>
                    <div class="footer-section footer-social">
                        ...
                        <div class="footer-social-icon-section">
                            <div class="social-icon-link"><a class="footer-social-link" href="https://www.facebook.com/jamescookuniversity" title="Facebook">
                                    <img class="footer-social-link-image" src="http://joblink.test/images/footer/social-icons/icon-facebook.svg" alt="Facebook logo"></a>
                            </div>
                            <div class="social-icon-link"><a class="footer-social-link" href=https://twitter.com/jcu" title="Twitter">
                                    <img class="footer-social-link-image" src="http://joblink.test/images/footer/social-icons/icon-twitter.svg" alt="Twitter logo"></a>
                            </div>
                            <div class="social-icon-link"><a class="footer-social-link" href="https://www.instagram.com/jamescookuniversity/" title="Instagram">
                                    <img class="footer-social-link-image" src="http://joblink.test/images/footer/social-icons/icon-instagram.svg" alt="Instagram logo"></a>
                            </div>
                            <div class="social-icon-link"><a class="footer-social-link" href="https://www.linkedin.com/school/james-cook-university/" title="LinkedIn">
                                    <img class="footer-social-link-image" src="http://joblink.test/images/footer/social-icons/icon-linkedin.svg" alt="LinkedIn logo"></a>
                            </div>
                            <div class="social-icon-link"><a class="footer-social-link" href="https://www.youtube.com/jamescookuniversity" title="Facebook">
                                    <img class="footer-social-link-image" src="http://joblink.test/images/footer/social-icons/icon-youtube.svg" alt="Youtube logo"></a>
                            </div>
                        </div>
                    </div>
                </div>
